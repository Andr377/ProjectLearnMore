...
@section('body')
    ...
    <div class="d-flex ms-5">
        <a class="btn btn-primary" href="/ManageCourse/InsertNewMaterial/{{ $course->id }}">Insert New Material</a>
        <a class="btn btn-danger ms-5" href="/ManageCourse/DeleteCourse/{{ $course->id }}">Delete Course</a>
    </div>
